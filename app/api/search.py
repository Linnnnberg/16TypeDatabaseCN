...
def search_celebrities(
    ...
    search_type: str = Query("all", description="Search type: all, name, description, tag, mbti"),
    ...
    popularity_filter: Optional[str] = Query(None, description="Filter by popularity: popular, recent, all"),
...
def get_search_suggestions(
    q: str = Query(..., min_length=2, description="Partial search query (minimum 2 characters)"),
